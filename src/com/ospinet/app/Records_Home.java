				...
				for (int i = 0; i < jsonMainNode.length(); i++) {
					if(i!=0)
					{
						...
						Description = jsonChildNode.optString("description");
						 ...
						 Tag = jsonChildNode.optString("group_concat(DISTINCT master_tag.tagname)");
						 AttachmentPath = jsonChildNode.optString("group_concat(DISTINCT records_file.filename)");
						 record r = new record();
